...
<div class="header" id="home">
	<div class="container">
		<ul>
			<li>
		  Sign Up
			<a href="" data-toggle="modal" data-target="#myModal2"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Company </a>
			<a href="" data-toggle="modal" data-target="#myModal2"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> User </a>
		</li>
		<li>
			<i class="fa fa-unlock-alt" aria-hidden="true"></i>Sign In 
			<a href="" data-toggle="modal" data-target="#myModal">Company </a>
	...
	<div class="header-bot_inner_wthreeinfo_header_mid">
		...
		<!-- header-bot -->
			<div class="col-md-4 logo_agile">
				<h1><a href="index.html"><span>Flurry</span>Mall <i class="fa fa-shopping-bag top_logo_agile_bag" aria-hidden="true"></i></a></h1>
			</div>
        <!-- header-bot -->
